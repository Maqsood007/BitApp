...
import com.bitfinex.bitapp.utils.DataParsingUtils.getFundingTickerRequest
import com.bitfinex.bitapp.utils.DataParsingUtils.getFundingTradeRequest
 ...
 */
class FundingLiveTickerTradeViewModel @ViewModelInject constructor() : ViewModel(),
    BitAppWebSocketListener {

    var fundingItem: String? = null
    ...
    fun startListeningPairLiveTicker() {
        ...
        webSocket.send(
            getFundingTickerRequest(fundingItem!!)
        )
        webSocket.send(
            getFundingTradeRequest(fundingItem!!)
        )
    }
    ...
    private fun updatePairTicker(text: String) {
        ...
        getTradingPairTickerItem(text, fundingItem!!)?.let { tradingPairTickerItem ->
